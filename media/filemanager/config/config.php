...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'].'/media',
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	'access_keys' => array('191a7cb7086e4e399cf2e76d6ca7b501'),
	...
	*******************/
	...
	'hidden_folders'                          => array('filemanager','thumbs'),
