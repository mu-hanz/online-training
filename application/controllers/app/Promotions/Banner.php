...
class Banner extends CI_Controller
{
    ...
    public function get_data_json()
    {
        ...
        $list = $this->Promotions_m->get_datatables_banner();
		$data = array();
        $no = $_POST['start'];
        $x = '1';
        foreach ($list as $row) {
        ...
        $data2 = array (
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Promotions_m->count_all_banner(),
            "recordsFiltered" => $this->Promotions_m->count_filtered_banner(),
            'data' => $data,
        );
    ...
    public function save()
    {
        ...
        $last_id_banner     = $this->Promotions_m->save_banner($data);
        if ($last_id_banner) {
    ...
    public function edit($id)
    {
        ...
        $title  = str_replace("_", " ", $this->file);
        $row    = $this->Promotions_m->get_data_banner($id);
    ...
    public function update()
    {
        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            $update_banner          = $this->Promotions_m->update_banner($id_data, $data);
        } else {
    ...
    public function delete()
    {
        ...
        if ($this->Promotions_m->delete_banner($id, $data)) {
