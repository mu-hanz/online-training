...
class Articles extends CI_Controller
{
    ...
    {
        $this->load->css('assets/system/css/jquery-ui.min.css');
        ...
        $this->load->js('assets/system/js/jquery-ui.min.js');
        ...
        if ($type == 'pages') {
            $data = array(
                'action'            => base_url('webadmin/post/save_post/' . $type),
                'text_button'       => 'Publish',
                'draft'             => 'Simpan Draft',
                'cancel'            => '',
                'post_title'        => '',
            ...
            $this->output->set_title('Buat Halaman Baru');
            ...
            $data = array(
                ...
                'data_term_current'    => array(),
                'data_term_tags'       => array(),
                'data_testi'           => array(),
                'data_gallery'         => array(),
                'event_subtitle'       => '',
                'product_name'         => '',
            ...
            $this->output->set_title('Buat Event Baru');
            ...
            $this->output->set_title('Buat Artikel Baru');
