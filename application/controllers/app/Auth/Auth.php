...
class Auth extends CI_Controller
{
	...
	public function login()
	{
		...
		else
		{
			...
			$this->data['identity'] = [
				...
				'id' => 'identity',
				'type' => 'text',
				'placeholder' => "hello@trainingcenter.events",
				'class'=>"form-control",
				'required'=>"",
			...
			$this->_render_page('app/auth' . DIRECTORY_SEPARATOR . 'login', $this->data);
		}
	}
	...
	public function change_password()
	{
		...
		if (!$this->ion_auth->logged_in())
		{
			redirect('webadmin/auth/login', 'refresh');
		}
		...
		else
		{
			...
			else
			{
				...
				redirect('/webadmin/auth/change_password', 'refresh');
			}
		}
	}
	...
	public function forgot_password()
	{
		...
		else
		{
			...
			if ($forgotten)
			{
				...
				$this->session->set_flashdata('message', $this->ion_auth->messages());
				redirect("webadmin/auth/login", 'refresh'); //we should display a confirmation page here instead of the login page
			}
			else
			{
				$this->session->set_flashdata('message', $this->ion_auth->errors());
		...
		if ($user)
		{
			...
			else
			{
				...
				else
				{
					...
					{
						$this->session->set_flashdata('message', $this->ion_auth->errors());
						redirect('webadmin/auth/reset_password/' . $code, 'refresh');
					}
				}
			}
		}
