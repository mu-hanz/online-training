...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="width: 100% !important; height: 100%; -webkit-text-size-adjust: none; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; background-color: #F4F4F7; color: #51545E; margin: 0;" bgcolor="#F4F4F7">
    <span class="preheader" style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">This is an invoice for your purchase on <?=$transaction_time;?>. Please submit payment by <?php echo date('Y-m-d H:i:s',strtotime('+4 days', strtotime($transaction_time))) ;?></span>
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 0;">
            <tr>
              <td class="email-masthead" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; text-align: center; padding: 25px 0;" align="center">
                <a href="<?php echo base_url();?>" class="f-fallback email-masthead_name" style="color: #A8AAAF; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
            ...
            <tr>
              <td class="email-body" width="100%" cellpadding="0" cellspacing="0" style="word-break: break-word; margin: 0; padding: 0; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; background-color: #FFFFFF;" bgcolor="#FFFFFF">
                <table class="email-body_inner" align="center" width="800" cellpadding="0" cellspacing="0" role="presentation" style="width: 800px; -premailer-width: 800px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; background-color: #FFFFFF; margin: 0 auto; padding: 0;" bgcolor="#FFFFFF">
                  <!-- Body content -->
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;">
                      <div class="f-fallback">
                        ...
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Thanks for using <strong style="color: #22BC66;">Training Center</strong>. This is an invoice for your recent purchase.</p>
              ...
              <strong>Amount Due:</strong> <?=$total;?>
                                ...
                                <tr>
                                  <td class="attributes_item" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 0;">
                                    <span class="f-fallback">
              <strong>Due By:</strong> <?php echo date('Y-m-d H:i:s',strtotime('+4 days', strtotime($transaction_time))) ;?>
            </span>
                                  </td>
                                </tr>
                                <?php } ?>
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                    <a href="<?=base_url('account/login');?>" class="f-fallback button button--green" target="_blank" style="color: #FFF; border-color: #22bc66; border-style: solid; border-width: 10px 18px; background-color: #22BC66; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">Login to Pay Invoice</a>
                                  </td>
                                </tr>
                              </table>
                        ...
                        <table class="purchase" width="100%" cellpadding="0" cellspacing="0" style="width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 35px 0;">
                          <tr>
                            <td style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                              <h3 style="margin-top: 0; color: #333333; font-size: 14px; font-weight: bold; text-align: left;" align="left">Order ID. <?=$order_id;?></h3>
                            </td>
                            <td style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                              <h3 class="align-right" style="margin-top: 0; color: #333333; font-size: 14px; font-weight: bold; text-align: right;" align="right"><?=$transaction_time;?></h3>
                            </td>
                          </tr>
                          <tr>
                            <td colspan="2" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                              <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0" style="width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 25px 0 0;">
                                ...
                                <?php foreach ($items as $item){ 
                                    $is_flexi = '';
                                    $sub = rupiah_num($item['subtotal']);
                                    if($item['sku'] == 'voucher'){
                                         $name = 'Kode Voucher <span style="color: #e73030;">['.strtoupper($item['name']).']</span>';
                                         $sub = '<span style="color: #e73030;">'.rupiah_num($item['subtotal']).'</span>';
                                     } else {
                                        $name = $item['name'].' x <strong>['.$item['qty'].']</strong>';
                                        $sub = rupiah_num($item['subtotal']);
                                     }
                                    
                                     if($item['sku'] != 'voucher'){
                                            if($item['used_flexi'] == 1){

                                                if($item['data_flexi']['discount_percent'] != 0){
                                                    
                                                    $sub = '<del style="color: #878787;font-size: 14px;">'.rupiah_num($item['old_subtotal']).'</del><br><span style="color: #e73030;">(- '.$item['data_flexi']['discount_percent'].'%)</span><br><strong>'.rupiah_num($item['subtotal']).'</strong>';

                                                } elseif($item['data_flexi']['discount_price'] != 0){
                                                    $sub = '<del style="color: #878787;font-size: 14px;">'.rupiah_num($item['old_subtotal']).'</del><br><span style="color: #e73030;">(- '.rupiah_num($item['data_flexi']['discount_price']).')</span><br><strong>'.rupiah_num($item['subtotal']).'</strong>';
                                                }

                                                $is_flexi = '<i> - Promo Flexi Combo</i>';
                                            }
                                        }
                                    
                                    ?>
                                <tr>
                                  <td width="80%" class="purchase_item" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 15px; color: #51545E; line-height: 18px; padding: 10px 0;"><span class="f-fallback"><?php echo $name;?> <?=$is_flexi;?></span></td>
                                  <td class="align-right" width="20%" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; text-align: right;" align="right"><span class="f-fallback"><?php echo $sub;?></span></td>
                                </tr>
                                <?php } ?>
                                <tr>
                                  ...
                                  <td width="20%" class="purchase_footer" valign="middle" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding-top: 15px; border-top-width: 1px; border-top-color: #EAEAEC; border-top-style: solid;">
                                    <p class="f-fallback purchase_total" style="font-size: 16px; line-height: 1.625; text-align: right; font-weight: bold; color: #333333; margin: 0;" align="right"><?=$total;?></p>
                                  </td>
                                </tr>
                              </table>
                            </td>
                        ...
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">If you have any questions about this invoice, simply reply to this email or reach out to our <a href="<?php echo base_url('contact-us');?>" style="color: #3869D4;">support team</a> for help.</p>
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Cheers,
                          <br />Training Center</p>
            ...
            <tr>
              <td style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                <table class="email-footer" align="center" width="800" cellpadding="0" cellspacing="0" role="presentation" style="width: 800px; -premailer-width: 800px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; text-align: center; margin: 0 auto; padding: 0;">
                  <tr>
                    <td class="content-cell" align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;">
                      <p class="f-fallback sub align-center" style="font-size: 13px; line-height: 1.625; text-align: center; color: #6B6E76; margin: .4em 0 1.1875em;" align="center">&copy; 2019 [Training Center by Premysis Consulting]. All rights reserved.</p>
                      <p class="f-fallback sub align-center" style="font-size: 13px; line-height: 1.625; text-align: center; color: #6B6E76; margin: .4em 0 1.1875em;" align="center">
                        ...
                        <br />Menara Rajawali 11 Floor
                        <br />Jl. Mega Kuningan Lot 5.1, Jakarta 12950 
                      </p>
                    </td>
                  </tr>
                </table>
