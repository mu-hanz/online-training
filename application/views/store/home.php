                ...
                <div class="intro-2 poition-relative">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-md-4 d-none d-sm-block">
                            <img class="card-img-top opacity-8" src="<?php echo base_url('assets/store/img/theme-illustration.png');?>" alt="image" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card item-card h-100 border-0">
                            <div class="item-card__image rounded">
                                <a href="single-product.html">
                                    <img src="<?php echo base_url('assets/store/img/520x400.png');?>" class="img-fluid rounded" alt=""> </a>
                                <div class="hover-icons">
                                    <ul class="list-unstyled">
                                        <li><a href="single-product.html"><i class="las la-desktop"></i></a></li>
                                        <li><a href="#"><i class="lar la-bookmark"></i></a></li>
                        ...
                        <div class="container">
                            ...
                            <div class="row d-flex align-items-center justify-content-md-center flex-wrap justify-content-sm-between">
                                <div class="col-sm-3 col-md-2">
                                    <img class="mx-auto img-fluid" src="<?php echo base_url('assets/store/img/120x50.png');?>" alt="Image description">
                                </div>
                                <div class="col-sm-3 col-md-2">
                                    <img class="mx-auto img-fluid" src="<?php echo base_url('assets/store/img/120x50.png');?>" alt="Image description">
                                </div>
                        ...
                        <div class="row justify-content-around align-items-center flex-md-row-reverse">
                            ...
                            <div class="col-4 mt-md-4 mt-lg-0">
                                <div class="image-wrap">
                                    <img class="d-none d-md-block img-fluid postion-relative mr-auto" src="<?php echo base_url('assets/store/img/08.png');?>" alt="Image">
                                </div>
                                <!-- end:Image wrap -->
                            </div>
                        </div>
            ...
            <section class="cta-big section">
                <div class="container">
                    <div class="cta-big-content bg-primary py-5 px-5 mt-4 rounded text-white position-relative">
                        <img alt="bg image" class="bg-image" src="<?php echo base_url('assets/store/img/bg-3.png');?>">
                        <div class="row d-flex align-items-center justify-content-center">
                            ...
                            <div class="col-lg-3 offset-lg-1 col-md-5 align-self-center">
                                <img src="<?php echo base_url('assets/store/img/illustrations/03.svg');?>" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
