...
class Midtrans {
    ...
    const SNAP_SANDBOX_BASE_URL_WEB = 'https://app.sandbox.midtrans.com/snap/v2';
    const SNAP_PRODUCTION_BASE_URL_WEB = 'https://app.midtrans.com/snap/v2';
    ...
    */
    ...
    public static function getSnapWebBaseUrl()
    {
      return Midtrans::$isProduction ?
          Midtrans::SNAP_PRODUCTION_BASE_URL_WEB : Midtrans::SNAP_SANDBOX_BASE_URL_WEB;
    }
